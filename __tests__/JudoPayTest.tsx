...
test('invokeApplePay will return mocked JudoResponse', async () => {
  ...
  const data = await judoPay.invokeApplePay(JudoTransactionMode.Payment, configuration)
...
test('invokeGooglePay will return mocked JudoResponse', async () => {
  ...
  const data = await judoPay.invokeGooglePay(JudoTransactionMode.Payment, configuration)
...
test('invokePaymentMethodScreen will return mocked JudoResponse', async () => {
  ...
  const data = await judoPay.invokePaymentMethodScreen(JudoTransactionMode.Payment, configuration)
