...
import {DEFAULT_SETTINGS_DATA, STORAGE_SETTINGS_KEY} from "../../Data/Constants";
import {judoAuthorizationFromSettingsData, judoConfigurationFromSettingsData} from "../../Data/Mapping";
...
export function useJudoConfiguration(): UseJudoConfigurationResult {
    ...
    const [configuration, setConfiguration] = useState<JudoConfiguration>(judoConfigurationFromSettingsData(settingsData))

    const { apiConfiguration: { isSandboxed } } = settingsData
