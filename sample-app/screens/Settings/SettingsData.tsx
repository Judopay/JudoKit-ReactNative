  ...
  list: [
    {
      data: [
        {
          entry: 'AED - United Arab Emirates Dirham',
          value: 'AED',
        } as PickerItem,
  ...
  list: [
    {
      data: [
        ...
        {
          entry: 'Trusted beneficiary',
          value: 'trustedBeneficiary',
        } as PickerItem,
        {
          entry: 'Transaction risk analysis',
  ...
  list: [
    {
      data: [
        ...
        {
          entry: 'Challenge preferred',
          value: 'challengePreferred',
        } as PickerItem,
        {
          entry: 'Challenge as mandate',
    ...
    },
    {
      ...
      data: [
        ...
        } as SettingsListItem,
        {
          ...
          subtitle:
            'If no payment reference is set, a random one will be generated',
          type: SettingsPickType.TextPicker,
          value: '',
        } as SettingsListItem,
      ],
    ...
    isIos ? applePaySettings : googlePaySettings,
    {
      ...
      data: [
        ...
        } as SettingsListItem,
        {
          ...
          subtitle:
            'Token payments require security code validation to complete',
          type: SettingsPickType.Switch,
          value: false,
        } as SettingsListItem,
        {
          ...
          subtitle:
            'Payment/PreAuth buttons will now display the amount & currency',
          type: SettingsPickType.Switch,
          value: true,
        } as SettingsListItem,
        {
