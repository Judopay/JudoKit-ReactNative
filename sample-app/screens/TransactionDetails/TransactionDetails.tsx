...
export default class TransactionDetails extends Component<TransactionDetailsProps, State> {
    ...
    render() {
        return (
            <SafeAreaView style={[styles.container]}>
                ...
                <TextInput placeholder="Ex: 638373033878224896"
                           placeholderTextColor="#a0a0a0"
                           onChangeText={(text) => this.textInputDidChange(text)}
                           style={styles.textInput} />
                <TouchableHighlight disabled={this.state.receiptId == undefined}
